<template>
	<div class="only">
		...
		<ul>
			...
			<li :class="{colour:isoks}" class="l">修改支付密码</li>
			<li :class="{colour:isokss}" class="l">完成</li>
		</ul>
		<!-- <div v-show="first">
			<p class="shouji">验证身份方式：<span>手机</span></p>
		...
		<!-- <div v-show="second">
			<p class="numbers"><span>*</span>新支付密码：<input type="text" /></p>
		...
		<div v-show="third" class="samll">
			...
			<p class=" success">恭喜您！修改支付密码成功！</p>
			<p class=" bangding">请牢记您的支付密码</p>
