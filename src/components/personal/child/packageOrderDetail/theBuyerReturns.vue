    ...
    <div class="center">
      ...
      <div class="middle">
        ...
        <div class="left l logo3">
          ...
          <div v-if="order_info.status == 11">
            <div class="Box">
              <div class="chuli">等待卖家退款 </div>
            </div>
          </div>
          <!--卖家同意退款退货申请-->
          <div v-if="order_info.status == 7" class="left l Logo3">
        ...
        <div class="right r">
          ...
          <div class="shangpin"><img v-lazy="URL + goods.pic_url" /><span>{{goods.title}}</span></div>
          <ul class="ul">
  ...
  export default {
    ...
    created() {
       if(localStorage.getItem('handlingPackageReturns')){
        this.refuhandlingPackageReturnsndInfo = JSON.parse(localStorage.getItem('handlingPackageReturns'));
      }else{
