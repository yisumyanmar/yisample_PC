      ...
      <div class="middle">
        <div class="left l">
          ...
          <div class="down">
            ...
            <div class="jine">退款金额：<span>*</span><input readonly type="text" @blur="setPrice" v-model="goods_price" /> 元（最多<span>{{parseFloat(goods_price)}}</span>元）<span class="huise">退款金额说明</span></div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      setPrice() {
        let total_refund = parseFloat(this.order_info.goods_price) * parseFloat(this.order_info.goods_num);
      ...
      open() {
        ...
        this.HTTP(this.$httpConfig.CommonOrderApplyForAfterSale, {
          ...
          let refundInfo = {
            order_sn_id:this.$route.order_sn_id,
            order_id: this.$route.params.id,
            goods_id: this.$route.params.goods_id,
            refund_id: '',
            store_id: ''
