  ...
  <div class="yuyin">
    ...
    <div class="center">
      ...
      <div class="choose"> 
        ...
        <!-- <div class="g-main-n l">
          <span class="l" v-for="(id, index) in attr" :key="index">{{id.attr_name}}</span>
...
export default {
  ...
  methods: {
    ...
    // 获取品牌
    getBrandList() {
      this.HTTP(this.$httpConfig.getBrandList, {class_id:this.$route.query.class_id}, "post").then(res => {
